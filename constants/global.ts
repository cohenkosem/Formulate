...
export abstract class GlobalConstants {
    ...
    static readonly WELCOME = "Due to the current situation in Israel, we are using all our computing power to help scan media for missing civilians. Formulate will not be functional for the forseeable future. Consider donating to Magen David Adom or Zaka if you can - https://www.mdais.org/en/donation or https://give.zakaworld.org/ and reach out to cohenkosem if you are in Israel and need assistance (transportation, food, medical help or locating a friend/family member). We are also working with the Chevra Kadisha and can arrange burial certificates."
